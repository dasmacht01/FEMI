...
# "inline_keyboard" is a function that converts
# list(list(tuple(str,str))) into InlineKeyboardMarkup object conveniently
# for more detailed implementations, refer to lrh.py
...
# ---Price--- #(generated by random module)
'''import random
